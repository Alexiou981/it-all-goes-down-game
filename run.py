...
def start_game():
    ...
    slowprint(
        ...
        "The destination is a magical island in the Pacific Ocean...\n" +
...
def choose_transportation():
    ...
    if transportation_vehicle.capitalize() == "Plane":
        ...
        slowprint(
            "\nEverything is running smoothly and the plane has leveled...\n" +
            "The fasten your seatbelts sign swithes off...\n" +
            "Soon the mini bar service will be available...\n" +
            "While you're waiting your browsing through the movies " +
            "available to you...\n\n" +
            "The cabin crew arrives with the food and drinks trolley...\n" +
            "You choose to get a drink, since you're tired and want to " +
            "get some sleep...\n\n" +
            "A few moments later and whilst you're half asleep...\n" +
            "You hear the captain announcing that we're expecting " +
            ...
            "Now you realise that theres something terrible going on...\n" +
            "The lights go off and the oxygen masks drop...\n")
        ...
        slowprint(
            ...
            "The captain announces that his lost control of the plane...\n" +
            "People are losing control and all you can hear " +
            "is screaming and crying...\n\n" +
            "The crew is shouting... BRACE BRACE BRACE!\n" +
            "You brace for impact, everything happens so fast " +
            ...
            "You need to find shelter, clothing, water and food...\n" +
            "You look left and right...\n" +
            "And realise that there is some sort of a forest " +
            "at the end of the beach...\n\n" +
            "Would you like to explore the forrest " +
            "for any useful objects for survival?\n" +
            "OR\n" +
        ...
        slowprint(
            ...
            "You arrive at the port, get the tickets and board the ship...\n" +
            "As soon as you locate the cabin the ship sets sale...\n\n")
        slowprint_ascii(ship)
        slowprint(
            "\nYour voyage begins and everything seems " +
            "to be running smooth...\n" +
            "You get yourself comfortable in your luxurious cabin,\n" +
            "and decide to head to the bar...\n\n" +
            "After having tried a few of their finest drinks " +
            "you start to feel tired...\n" +
            "You return to your cabin and decide to get some sleep...\n\n" +
            "Several hours later...\n\n" +
            "A loud noise and an impact that felt like the ship crashed " +
            "onto something...\n" +
            "You get outside and realise that there is\n" +
            "an emergency evacuation procedure happening...\n" +
...
def jump_or_stay():
    ...
    if jump_stay.capitalize() == "Jump":
        ...
        slowprint(
            ...
            "The temperature of the water is really low " +
            "and the waves are massive...\n\n" +
            "Despite your efforts to stand still and remain in groups,\n" +
            "strong currents take you away and whilst trying " +
            "to go against them...\n" +
            ...
            "You feel your whole body aching and extremely dehydrated...\n" +
            "The sun is getting hotter and hotter...\n\n" +
            "You need to find yourself shelter, clothes, water and food...\n" +
            "You look left and right...\n" +
            "And realise that there is some sort of a forest " +
            "at the end of the beach...\n\n" +
            "Would you like to explore the forrest " +
        ...
        print("You've entered an invalid value," +
              "please reply with Jump or Stay")
        jump_or_stay()
...
def try_again():
    ...
    while True:
        ...
        if try_again_answer.capitalize() == "Yes":
            ...
            slowprint("It's so sad to see you go... " +
                      "Thanks for playing the game :D\n")
            slowprint("\nGoodbye for now!!!\n\n")
            slowprint("This game was created for educational purposes " +
    ...
    while True:
        ...
        if drink_answer.capitalize() == "Yes":
            slowprint("You drink plenty of water rehydrate yourself...\n" +
                      ...
                      "You come accross some fruit trees. " +
                      "As you get closer realise...\n" +
                      "Those trees are banana trees and " +
...
def beach_or_explore():
    ...
    depending on users decision. It also ensure that no invalid values are
    being input and explains to the user which values are valid.
    """
    while True:
        beach_or_explore = input()
        if beach_or_explore.capitalize() == "Beach":
            slowprint("You stayed at the beach...\n" +
                      "You didn't find anything around, " +
                      "the night came in...\n" +
            ...
            slowprint("You decice to explore the forest...\n" +
                      "You head towards it...\n" +
                      "After having entered the tropical forest " +
                      "and walked for several hours...\n" +
                      "you came across a lake with fresh water," +
                      "with many fish swimming in it\n" +
                      "and animals drinking water from it...\n\n" +
                      "After so many hours of being unconsious " +
                      "you feel extremely dehydrated...\n" +
                      "Would you like to drink from the lake? (Yes/No)\n")
            drink_from_lake()
            break
        else:
            print("You've entered an invalid value." +
                  "Please reply Beach or Explore")


def uphill_downlhill():
    """
    This function unveals the story depending on which path the player
    has decided to take. It also prints an error message
    if an empty or invalid answer has been typed in.
    """
    while True:
        ...
        if uphill_downhill_answer.capitalize() == "Uphill":
            slowprint("You've decided to go uphill...\n" +
                      ...
                      "this is a good sign that other people " +
                      "have definitely been here before...\n" +
                      "Your hopes for survival raise significantly...\n\n" +
                      "You continue walking uphill and " +
                      "after a while of more walking...\n" +
                      "The ground seems to start leveling and " +
                      ...
                      "To your own luck however, " +
                      "you find working facilities and beds...\n" +
                      "This means that you can survive the night " +
                      "inside the shelter...\n" +
                      "You have a look around the shelter...\n\n" +
                      "You couldn't find any food anywhere...\n" +
                      "However, you managed to spot some items " +
                      "that might appear useful later on...\n" +
                      "Inside a small box you find...\n" +
                      "a sack, clothing, matches, a knife, bottled water,\n" +
                      "rope and a pair of binoculars...\n\n" +
                      "You start to feel tired and " +
                      "decide to get some rest...\n\n" +
                      "The next day as soon as the sun rises...\n" +
                      "You get ready to continue your search " +
                      "for food and medical care...\n" +
                      "The sack and items you found yesterday " +
                      "might appear to be useful...\n" +
                      "You decide to take it and include inside " +
                      "the items you found...\n\n" +
                      "It is a sunny day and the atmosphere " +
                      "clear of fog...\n" +
                      "The shelter being located at the top of a hill,\n" +
                      "gives you great visibility of the " +
                      "surrounding landscape...\n\n" +
                      "You have a look around and try to " +
                      "decide which way to go...\n" +
                      "On the West side of the shelter " +
                      "and far into the horizon...\n" +
                      "Appear to be a few buildings or warehouses...\n\n" +
                      "On the East side of the shelter, " +
                      "behind some trees...\n" +
            ...
            slowprint("You've decided to go downhill...\n" +
                      ...
                      "more rocky and desserted...\n\n" +
                      "You walk for many miles and come accross a cave...\n" +
                      "That could be your shelter for the night...\n" +
                      "As you get closer you spot a backpack " +
                      "by the entrance of the cave...\n" +
                      "Your hopes that there's other people " +
                      "on the island get up...\n\n" +
                      "You decide to enter the cave and " +
                      "shout to see if anyone is inside...\n" +
                      "You don't hear anything back " +
                      "and assume you're alone...\n" +
                      "If there's nobody inside then " +
                      ...
                      "Different scenarios of what could go wrong " +
            ...
            print("You've entered an invalid value." +
                  "Please reply with Uphill or Downhill.")


def west_or_east():
    """
    This function gets the users decision to head West or East and unfolds
    the story depending on the choice. It also prints an error if an empty
    or invalid values has been typed in.
    """
    while True:
        ...
        if west_east_answer.capitalize() == "West":
            slowprint("You decide to go West...\n" +
                      ...
                      "what appeared to be buildings...\n\n" +
                      "Suddenly, you hear a ruslting noise " +
                      "from inside the woods...\n" +
                      "You turn around and realise that it is a Wild Boar\n" +
                      "Looking towards you, preparing to attack...\n\n" +
                      "You time is limited " +
                      "and your decision is necessary...\n" +
            ...
            slowprint("You decide to go East...\n" +
                      "You start walking towards the direction " +
                      "that smoke was coming from...\n" +
                      "Luckily, the destination is not very far " +
                      "and within hours...\n" +
                      "You walk your way there and you finally arrive...\n\n" +
                      "The closer you get the darker " +
                      "and thicker the smoke gets...\n" +
                      "Soon you realise that " +
                      "this fire was not intentional...\n" +
    ...
    while True:
        ...
        if fight_flight_answer.capitalize() == "Fight":
            slowprint("You fight as hard as you can for your life...\n" +
                      "You managed to stab it with the knife " +
                      "but it didn't seem to work...\n" +
                      "You're knife is stuck and you let go of it...\n" +
            ...
            slowprint("You run away as fast as you can gor you life...\n" +
                      "You're looking for a shelter to protect " +
                      "you from the threat..\n" +
                      "As you continue running " +
                      "you come across a tall tree...\n\n" +
                      "You manage to climb on it fast enough " +
                      "to avoid the boar...\n" +
                      "You wait on top of the tree patiently...\n" +
                      "Almost one hour has passed by and "
                      "you are looking around\n" +
                      "to ensure that the danger is now gone " +
                      "and the ground is safe...\n\n" +
                      "You start making your way down and heading West...\n" +
                      "You've used up so much energy during " +
                      "the chase and you feel\n" +
                      "exhausted and extremely hungry...\n\n" +
                      "Regardless the fatigue, " +
                      "the hunger and the pain you continue walking...\n" +
                      "The more you walk you start to realise " +
                      "that the trees are getting\n" +
                      "less and less, and those buildings seem to be " +
                      "closer than ever now...\n\n" +
                      "As you're getting closer you're being approached " +
                      ...
                      "and take you to the emergencies...\n" +
                      "The doctors and nurser take great care of you...\n" +
                      "A few moments later and " +
                      "having regained your strength...\n\n" +
                      "You get in touch with your embassy " +
                      "and report as a survivor\n" +
                      "of this tragedy...\n" +
                      "To your surprise they inform you that " +
                      "you're the only survivor so far...\n" +
                      "They also inform you that no ruins " +
                      "have been found yet...\n\n" +
            ...
            print("You've entered an invalid value. " +
                  "Please reply Fight or Flight.")


def stop_fire_seek_help():
    """
    This function gets the users decision to try to Stop the fire or Seek out
    for help, depending on the choice the story takes a different turn.
    It also prints an error if invalid or empty value has been input.
    """
    while True:
        ...
        if stop_help_answer.capitalize() == "Stop":
            slowprint("You've chosen to try and put out the fire...\n" +
                      ...
                      "You use the bottled water from your bag...\n\n" +
            ...
            slowprint("You've decided to seek out for help...\n" +
                      "You run as fast as you can giving everything " +
                      "you've got...\n" +
                      ...
                      "and after managing to catch your breath " +
                      "you start explaining...\n\n" +
                      "You prioritise mentioning about the " +
                      "fire and firefighters\n" +
                      "are on the way to put out the fire...\n\n" +
                      "You then explain to them about " +
                      "the tragedy you were in...\n" +
                      "One of the villagers offers to give you " +
                      "a lift to the hospital...\n" +
                      "There's no immediate access " +
                      "to an ambulance in that area...\n" +
                      ...
                      "You get in touch with your embassy and " +
                      "inform them you're a survivor...\n" +
                      "They are surprised to hear that " +
                      "and reassure you a safe return at home...\n" +
                      "To your surprise they inform you that " +
                      "so far you're the only survivor\n" +
                      "of the crash...\n\n" +
                      "The embassy manages to get you in touch " +
                      "with your family...\n" +
                      "You inform them that you're safe and sound...\n" +
                      "They sound delighted and extremely relieved...\n\n" +
                      "In the meantime, the firefighters have managed " +
                      "to put it out...\n" +
            ...
            print("You've entered an invalid value. " +
                  "Please reply Stop or Help.\n")


def main():
    """
    This function includes the two basic functions that start the game,
    use this and call the main function which will run any functions called
